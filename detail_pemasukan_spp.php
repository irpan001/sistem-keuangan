        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              ...
              ?>
              <h6 class="h2 text-white d-inline-block mb-0">Data Keuangan SPP <?php echo $data['nama']; ?></h6>
            </div>

            <div class="col-lg-6 col-5 text-right">
              <a href="cetak_d_p_spp.php?id_siswa=<?php echo $data["id_siswa"]; ?>" target="blank" class="btn btn-sm btn-neutral">Cetak</a>
            </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <h2 class="mb-0"><a href="pemasukan_spp.php"><i class="ni ni-bold-left"></i></a> Riwayat Pembayaran</h2>
                </div>
             ...
             <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                  <?php $i=1; ?>
                     <?php
                  $sql = mysqli_query($koneksi, "SELECT * FROM pemasukanspp WHERE id_siswa='$data[id_siswa]' ORDER BY id_pemasukanspp ASC");
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td> 
                      <h3>Rp <?=number_format($masuk['totalspp'],2,',','.');?></h3>
                    </td>  
                  </tr>
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <?php
                  ...
                  $sisa['sisa'] = ($rincianspp['totalrspp']*12) - $masuk['totalspp'];
                ?>
                  ...
                  <tr>
                    ...
                    <td> 
                      <h3>Rp <?=number_format($rincianspp['totalrspp'] *12,2,',','.');?></h3>
                    </td> 
                  </tr>
