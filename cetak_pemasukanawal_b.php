...
<br><br>
<p align="center">
    <strong>LAPORAN PEMASUKAN AWAL TAHUN KELAS B</strong>
                  ...
                  <tr>
                   ...
                   <tr>
                         <?php  
                            ...
                            $query = mysqli_query($koneksi, "SELECT sum(jumlah) as totalpemasukanawalb FROM pemasukanawalb");  
                            // tampilkan data
                    ...
                    <td valign="top">
                      Rp. <?=number_format($data['totalpemasukanawalb'],2,',','.');?>
                    </td>
