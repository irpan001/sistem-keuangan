...
<br><br>
<p align="center">
    <strong>BUKTI PEMBAYARAN SPP TAHUN</b></strong>
...
<table align="center" border="1" cellspacing="0" cellpadding="10px">
    <tbody>
        ...
        <tbody>
                       ...
                       <?php $i=1; ?>
                     <?php
                  $sql = mysqli_query($koneksi, "SELECT * FROM pemasukanspp WHERE id_siswa='$data[id_siswa]'");
                  ...
                  <tr>
                    <?php
                  $bayaran1=mysqli_query($koneksi,"SELECT * FROM pemasukanspp WHERE id_siswa='$data[id_siswa]'");
                  while ($bayarmasuk1=mysqli_fetch_array($bayaran1)){
                  $arraybayaran1[] = $bayarmasuk1['jumlah'];
                   }
                  $jumlahbayar1 = array_sum($arraybayaran1); 

                  $biaya=mysqli_query($koneksi,"SELECT * FROM rincianspp");
                  ...
                  $tunggakan = ($jumlahbiaya *12) - $jumlahbayar1;
                ?>
