          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <h2 class="mb-0">Riwayat Pembayaran Awal Tahun B</h2>
                </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                  <?php $i=1; ?>
                      ...
                      <?php 
                      $awal = query("SELECT * FROM pemasukanawalb WHERE id_siswa = '$id_siswa'");
                      ?>  
                ...
                <tbody class="list">
                  ...
                  <tr>
                    ...
                    <td> 
                      <h3>Rp <?=number_format($row['totalawalb'],2,',','.');?></h3>
                    </td>  
                  </tr>
                ...
                <tbody class="list">
                  ...
                  <tr>
                    ...
                    <td> 
                      ...
                      $awal = query("SELECT sum(jumlah) as totalawalb FROM pemasukanawalb WHERE id_siswa = '$id_siswa'");
                      $sisa['sisa'] = $rincianawalb['totalrawalb'] - $row['totalawalb'];
