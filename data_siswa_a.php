          ...
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
             ...
             <div class="col-lg-6 col-5 text-right">
              <a href="#" class="btn btn-sm btn-neutral" data-toggle="modal" data-target="#myModalresetsiswaa">Reset Data</a>
            </div>
<!-- reset -->
<div id="myModalresetsiswaa" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <!-- body modal -->
    <form action="reset_siswa_a.php" method="get">
        ...
        <button href="reset_siswa_a.php" class="btn btn-success" >Ya</button>
    </form>
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="export_siswa_a.php" class="btn btn-sm btn-primary">Rekap Data</a>
                </div>
              </div>
            </div>
            ...
            <div class="card-footer py-4">
              ...
              <nav aria-label="...">
                <ul class="pagination justify-content-end mb-0">
                  ...
                  <li class="page-item">
                    <a class="page-link" href="data_siswa_a.php?halaman=<?php echo $i; ?>"><?php echo $i; ?></u></a>
                  </li>
