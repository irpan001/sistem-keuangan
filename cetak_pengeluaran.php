                 ...
                 <thead>
                  <tr>
                    <tH valign="top" align="center">NO</th>
                     ...
                     <tH width="150" valign="top" align="center">TANGGAL PENGELUARAN</th>
        ...
        <tbody>
                  ...
                  <tr>
                    ...
                    <td valign="top">
                       ...
                       ?>
                       <?php echo date("d-m-Y", strtotime($tgl_pengeluaran)); ?>
                    </td>
                   ...
                   <tr>
                         <?php  
                            ...
                            $query = mysqli_query($koneksi, "SELECT sum(jumlah) as totalpengeluaran FROM pengeluaran");  
                            // tampilkan data
                    ...
                    <td valign="top">
                      Rp. <?=number_format($data['totalpengeluaran'],2,',','.');?>
                    </td>
