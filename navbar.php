      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="rincian_awal.php">
                <i class="ni ni-align-center text-blue"></i>
                <span class="nav-link-text">Rincian Keuangan</span>
              </a>
              </li>

            <li class="nav-item">
              <a class="nav-link" href="pemasukan_awal.php">
            ...
            <li class="nav-item pcoded-hasmenu">
              <a class="nav-link "><span class="pcoded-mtext">Data Sekolah</span></a>
            </li>
