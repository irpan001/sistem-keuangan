        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="cetak_d_p_awal_b.php?id_siswa=<?php echo $data["id_siswa"]; ?>" target="blank" class="btn btn-sm btn-neutral">Cetak</a>
            </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <h2 class="mb-0"><a href="pemasukan_awal_b.php"><i class="ni ni-bold-left"></i></a> Riwayat Pembayaran</h2>
                </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td> 
                      <h3>Rp <?=number_format($masuk['totalawalb'],2,',','.');?></h3>
                    </td>  
                  </tr>
              ...
              <table class="table align-items-center table-flush">
                ...
                <?php
                  ...
                  $rincianawalb = mysqli_fetch_assoc($queryrincianawalb);
                   ...
                   $sisa['sisa'] = $rincianawalb['totalrawalb'] - $masuk['totalawalb'];
                ?>
                  ...
                  <tr>
                    ...
                    <td> 
                      <h3>Rp <?=number_format($rincianawalb['totalrawalb'],2,',','.');?></h3>
                    </td> 
                  </tr>
