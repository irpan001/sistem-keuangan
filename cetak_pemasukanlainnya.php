...
<br><br>
<p align="center">
    <strong>LAPORAN PEMASUKAN LAINNYA</strong>
    ...
    <tbody>
                 <thead>
                  <tr>
                     ...
                     <tH width="200" valign="top" align="center">KETERANGAN</th>
                     <tH width="200" valign="top" align="center">TANGGAL</th>
        ...
        <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      ?>
                      <?php echo date("d-m-Y", strtotime($tgl_lainnya)); ?>
                    </td>
                    <td valign="top">
                   ...
                   <tr>
                         <?php  
                            ...
                            $query = mysqli_query($koneksi, "SELECT sum(jumlah) as totallainnya FROM lainnya");  
                            // tampilkan data
                    ...
                    <td valign="top">
                      Rp. <?=number_format($data['totallainnya'],2,',','.');?>
                    </td>
