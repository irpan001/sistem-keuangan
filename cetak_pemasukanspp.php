...
<br><br>
<p align="center">
    <strong>LAPORAN PEMASUKAN SPP</strong>
                  ...
                  <tr>
                   ...
                   <tr>
                         <?php  
                            ...
                            $query = mysqli_query($koneksi, "SELECT sum(jumlah) as totalpemasukanspp FROM pemasukanspp");  
                            // tampilkan data
                    ...
                    <td valign="top">
                      Rp. <?=number_format($data['totalpemasukanspp'],2,',','.');?>
                    </td>
